			   ...
			   <table class="table table-responsive">
				  <tbody>
					 ...
					 <tr>
						...
						<td><h3><?php echo CURRENCY.' '.number_format((float)$settle_sale['cash_sale_without_vat'], 2, '.', ''); ?></h3></td>
					 </tr>
					 <tr>
						<td>
							<h3>Total Cash VAT</h3>
						</td>
						<td><h3><?php echo CURRENCY.' '.number_format((float)$settle_sale['cash_sale_vat'], 2, '.', ''); ?></h3></td>
					 </tr>
					 <tr>
						<td>
							<h3>Total Card Sale</h3>
						</td>
						<td><h3><?php echo CURRENCY.' '.number_format((float)$settle_sale['card_sale_without_vat'], 2, '.', ''); ?></h3></td>
					 </tr>
					 <tr>
						<td>
							<h3>Total Card VAT</h3>
						</td>
						<td><h3><?php echo CURRENCY.' '.number_format((float)$settle_sale['card_sale_vat'], 2, '.', ''); ?></h3></td>
					 </tr>
					 <tr>
						<td>
							<h3>Final Total</h3>
						</td>
						<td><h3><?php echo CURRENCY.' '.number_format((float)$settle_sale['cash_drawer'], 2, '.', ''); ?></h3></td>
					 </tr>
					</tbody>					
			   </table>
