			  ...
			  <table class="table table-striped table-bordered table-hover table-heading no-border-bottom">
				<tbody>
					<tr class="cod_custom_table_body_totaltrs">
						...
						<?php } ?>
						<tr class="cod_custom_table_body_totaltrs">
						   <td>Discount<span class="disprice">INR <?php echo number_format($sale_order['discount'], 2); ?></span></td>
					   ...
					   <td>
						  <div class="form-group">
							 ...
							 <select class="form-control payment_status" data-id = <?php echo $sale_order['id']; ?> name="payment_status_<?php echo $sale_order['id']; ?>" id="payment_status_<?php echo $sale_order['id']; ?>">
								<option value="paid" <?php if($sale_order['payment_status'] == 'paid') { echo "Selected"; } ?>>Paid</option>
								<option value="unpaid" <?php if($sale_order['payment_status'] == 'unpaid') { echo "Selected"; } ?>>Un Paid</option>
							 </select>
						  </div>
					   </td>
					   <td>
