...
<table class="table" cellspacing="0" border="0">
   ...
   <?php
	...
	echo "</tr>";
	echo "<tr>";
	echo "<td style='font-size:12px;float:left; width:70%;$style_print'>Total Cash VAT</td>";
	...
	echo "</tr>";
	echo "<tr>";
	echo "<td style='font-size:12px;float:left; width:70%;$style_print'>Total Card VAT</td>";
