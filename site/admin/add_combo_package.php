...
if(isset($_POST['category_post'])) {
	...
	redirect('manage_combo_package.php?resp=addsucc');
}
				...
				<div class="row">
					<div id="breadcrumb" class="col-xs-12">
						...
						<ol class="breadcrumb pull-left">
							...
							<li><a href="javascript:void(0); ">Add Combo Package</a></li>
						</ol>
					</div>
				</div>
						...
						<div class="box">
							<div class="box-header">
								<div class="box-name">
									...
									<span>Manage Combo Package</span>
								</div>
								<div class="box-icons">
							...
							<div class="box-content">
								<form id="categoryForm" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
									...
									<fieldset>
										<legend>Add Combo Package</legend>									
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control" name="package_name" id="package_name" value="<?php echo safeTextOut(htmlspecialchars($package_name)); ?>" required/>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Package Price</label>
											<div class="col-sm-5">
												<input type="text" class="form-control" name="package_price" id="package_price" value="<?php echo safeTextOut(htmlspecialchars($package_price)); ?>" required/>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">No. of Items</label>
											<div class="col-sm-5">
												<input type="text" class="form-control" name="package_items" id="package_items" value="<?php echo safeTextOut(htmlspecialchars($package_items)); ?>" required/>
											</div>
										</div>
									</fieldset>									
									<div class="form-group">
										<div class="col-sm-9 col-sm-offset-3">
											...
											?>
												...
												<a href="manage_combo_package.php" class="btn btn-primary">Cancel</a>
											<?php } 
												else { 
											?>
