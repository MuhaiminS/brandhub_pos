...
if(isset($_POST['category_post'])) {
	...
	redirect('manage_item_category.php?resp=addsucc');
}
								...
								<form id="categoryForm" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
									...
									<fieldset>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control" name="category_title" id="category_title" value="<?php echo safeTextOut(htmlspecialchars($category_title)); ?>" />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control" name="category_slug" id="category_slug" value="<?php echo safeTextOut(htmlspecialchars($category_slug)); ?>" />
											</div>
										</div>
									</fieldset>									
									<div class="form-group">
										<div class="col-sm-9 col-sm-offset-3">
											...
											?>
												...
												<a href="manage_item_category.php" class="btn btn-primary">Cancel</a>
											<?php } 
												else { 
											?>
