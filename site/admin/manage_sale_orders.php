			...
			<div id="">
				...
				<div class="row">
				  ...
				  <ul class="nav nav-tabs">
					<li class="active"><a href="manage_sale_orders.php">Counter Sale</a></li>
					 <li><a href="combo_sale.php">Combo Sale</a></li>
				  </ul>
						...
						<div class="row">			
							...
							<div class="form-group search_val" style="margin-bottom:0px;">	
								...
								<a href="manage_sale_orders.php" style="font-size: 20px;" class="aa-search-btn reset_btn" title="Reset"><i class="fa fa-repeat" ></i></a>
								    ...
								    <?php } else { ?>
    								<span title="Excel" class="print2" style="font-size: 20px;"><a target="_blank" href="excel_export.php?sale=Counter Sale&order_type=counter_sale&get_type=excel" class="print excel_me"><i class="fa fa-file-excel-o"></i></a></span>
    								<?php } ?>
								</div>
							</div>
							</form>
													...
													if($prs != false) {
														...
														if($pcount > 0) {
															for($p = 0; $p < $pcount; $p++) {
																...
																echo " <td class='hide_print'><a data-toggle='modal' data-target='#myModal".$id."' style='cursor:pointer;'><i class='fa fa fa-eye'></i></a> | <a href='single_item_print.php?id=$id&re=manage_sale_orders.php'><i class='fa fa-print'></i></a></td>";
																}
																echo "</tr>";
