				...
				<div class="row">
					<div id="breadcrumb" class="col-xs-12">
						...
						<ol class="breadcrumb pull-left">
							...
							<li><a href="javascript:void(0);">Manage Item Category</a></li>
						</ol>
					</div>
				</div>
						...
						<div class="box">
							<div class="box-header">
								<div class="box-name">
									...
									<span>Manage Item Category List</span>
								</div>
								<div class="box-icons">
											...
											if($prs != false) {
												...
												if($pcount > 0) {
													for($p = 0; $p < $pcount; $p++) {
														...
														echo "<tr>";
														echo "<td>".$cat_id."</td>";
														echo "<td>".safeTextOut($category_title)."</td>";
														//echo "<td>".$parent_category."</td>";
														//echo "<td><img src=\"".$category_img_dir.$category_img."\" width=\"100\" height=\"100\"  alt=\"".$category_title."\" /></td>";
														echo "<td><a href='add_item_category.php?id=".$cat_id."&act=edit'>Edit</a> | <a href='javascript:void(0)' onclick='deleteIt($cat_id);'>Delete</a>
														</td>";
														echo "</tr>";
													}
												}
