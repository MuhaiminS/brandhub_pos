				...
				<div class="row">
					<div id="breadcrumb" class="col-xs-12">
						...
						<ol class="breadcrumb pull-left">
							...
							<li><a href="javascript:void(0);">Manage Staffs</a></li>
						</ol>
					</div>
				</div>
											...
											if($prs != false) {
												...
												if($pcount > 0) {
													for($p = 0; $p < $pcount; $p++) {
														...
														//echo "<td>".safeTextOut($manufacturing)."</td>";														
														echo "<td>".safeTextOut($name)."</td>";
														echo "<td>".safeTextOut($doj)."</td>";
														echo "<td>";
															echo "<a href='add_drivers.php?id=".$id."&act=edit'>Edit</a>";
												...
												echo "<tr>";
												echo "<td>No Staffs found to list.</td>";
												echo "</tr>";
											}
										?>						
									</tbody>
