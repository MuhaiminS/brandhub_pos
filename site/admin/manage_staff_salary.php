...
{
	$qry="SELECT * from staff_salary Order BY id DESC";
				...
				<div class="row">
					<div id="breadcrumb" class="col-xs-12">
						...
						<ol class="breadcrumb pull-left">
							...
							<li><a href="javascript:void(0);">Manage Staffs Salary</a></li>
						</ol>
					</div>
				</div>
											...
											if($prs != false) {
												...
												if($pcount > 0) {
													for($p = 0; $p < $pcount; $p++) {
														...
														$month_year = $prow->month_year;
														$basic_salary = $prow->basic_salary;
														$allowance = $prow->allowance;
														...
														echo "<td>".safeTextOut($basic_salary)."</td>";
														echo "<td>".safeTextOut($allowance)."</td>";
														echo "<td>".safeTextOut($month_year)."</td>";
														echo "<td>";
															echo "<a href='add_staff_salary.php?id=".$id."&act=edit'>Edit</a>";
...
{
    if(id && confirm('Are you sure you want to delete this Staff?'))
    {
        window.location.href = site_url+'/admin/manage_drivers.php?id='+id+'&act=delete';
    }
}
