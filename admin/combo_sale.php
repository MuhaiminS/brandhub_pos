			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li class="active">Combo Sales</li>
					</ol>
				</section>
				<!-- Main content -->
						...
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<h3 class="box-title">Combo Sales</h3>
								</div>
								<!-- /.box-header -->
								<div class="box-body">
									<div id="form" class="panel panel-warning" style="display: block;">
										<div class="panel-body">
											<form action="combo_sale.php" accept-charset="utf-8">
												...
												<div class="row">
													...
													<div class="col-sm-12">
														...
														<a href="combo_sale.php" class="btn btn-default">Reset</a>
													</div>
												</div>
											</form>
										</div>
										...
										<div class="col-md-6 text-right pr0">
											<div class="dt-buttons btn-group">												
												<?php if($receipt_ids != '' || $shops != '' || $payment_types != '' || $from_date1 != '' || $to_date1 != '') { ?>
												    ...
												    <?php } else { ?>
				    								<span title="Excel" class="print2" style="font-size: 20px;"><a target="_blank" href="excel_export.php?sale=Counter Sale&order_type=combo&get_type=excel" class="btn btn-default buttons-csv buttons-html5 excel_me"><span>Excel</span></a></span>
				    								<?php } ?>
													...
													if($prs != false) {
														...
														if($pcount > 0) {
															for($p = 0; $p < $pcount; $p++) {
																...
																$combo_package_gst = $prow->combo_package_gst;
																...
																$total = $net_total = $total_cgst1=$total_sgst1 ="0.00";
																...
																if($prs2 != false) {
																	...
																	if($pcount2 > 0) {
																		...
																		$with_vat_price = $combo_package_price + (($combo_package_price / 100) * ($vat));
																			...
																			$cgst = $combo_package_gst/2;
																	 		$sgst = $combo_package_gst/2;
																			
																	}
																}
																			$total_cgst1 = $combo_package_price/100*$cgst;
													   						$total_sgst1 = $combo_package_price/100*$sgst;
																echo "<tr>";
																echo "<td>".$id."</td>";
																...
																echo "<td align='right'>".number_format($cgst, 2)."</td>";
																echo "<td align='right'>".number_format($sgst, 2)."</td>";
																} } 
																if(BILL_TAX == 'yes'){ if(BILL_TAX_TYPE == 'VAT'){
																echo "<td>".number_format($with_vat_price-$discount, 2)."</td>";	} elseif(BILL_TAX_TYPE == 'GST'){	
																echo "<td align='right'>".number_format($combo_package_price-$discount + $total_cgst1 + $total_sgst1, 2)."</td>";		
																} }										
																if($status == 'deleted'){
																...
																$grand_total += $with_vat_price-$discount;
															 	$grand_tota_gst += $total + $total_cgst1 + $total_sgst1 + $discount;
															}
															echo "<tr>";
															...
															echo "<td colspan='1'>".number_format($grand_total, 2)."</td>";
															 	...
															 	echo "<td colspan='1'>".number_format($grand_tota_gst, 2)."</td>";
															 	 } }
															echo "</tr>";
														}else {
														echo "<tr>";
