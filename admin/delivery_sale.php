<?php 
	...
	$order_type = (isset($_GET['order_type']) && $_GET['order_type'] !='') ? $_GET['order_type'] : 'delivery_sale';
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li class="active">Delivery Sales</li>
					</ol>
				</section>
				<!-- Main content -->
						...
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<h3 class="box-title">Delivery Sales</h3>
								</div>
								<!-- /.box-header -->
								<div class="box-body">
									<div id="form" class="panel panel-warning" style="display: block;">
										<div class="panel-body">
											<form action="delivery_sale.php" accept-charset="utf-8">
												...
												<div class="row">
													...
													<div class="col-sm-12">
														...
														<a href="delivery_sale.php?order_type=<?php echo $order_type; ?>" class="btn btn-default">Reset</a>
													</div>
												</div>
											</form>
										</div>
									...
									<div class="row">
										...
										<div class="col-md-6 text-right pr0">
											<div class="dt-buttons btn-group">												
												...
												<a target="_blank" href="excel_export.php?sale=Delivery Sale&order_type=delivery&get_type=excel&receipt_id=<?php echo $receipt_ids; ?>&shop=<?php echo $shops; ?>&payment_type=<?php echo $payment_types; ?>&from_date=<?php echo $from_date1; ?>&to_date=<?php echo $to_date1; ?>" class="btn btn-default buttons-csv buttons-html5 export"><span>Excel</span></a>
												 <?php } else { ?>
												<a target="_blank" href="excel_export.php?sale=Delivery Sale&order_type=delivery&get_type=excel" class="btn btn-default buttons-csv buttons-html5 export"><span>Excel</span></a>
												<?php } ?>
												...
												if($prs != false) {
													...
													if($pcount > 0) {
														for($p = 0; $p < $pcount; $p++) {
															...
															echo "<td align='right'>".number_format($with_vat_price-$discount, 2)."</td>";												
															if($status == 'deleted'){
																echo "<td></td>";
															}else{
																echo "<td class='hide_print'>";
																	echo "<div class=\"text-center\">";
																		echo "<div class=\"btn-group\">";
																			echo "<a href=\"javascript:void(0)\" data-toggle=\"modal\"title=\"View\" data-target=\"#myModal".$id."\" title=\"View Items\" class=\"tip btn btn-warning btn-xs\"><i class=\"fa fa-file-text-o\"></i></a>";
														...
														echo "<td colspan='1' align='right'>".number_format($grand_total, 2)."</td>";
