<?php 
	...
	function getSaleorders($receipt_id = '',$payment_type = '', $from_date ='', $to_date='', $shop='', $pageLimit='', $setLimit='', $export="", $order_type="")
	{
		...
		$order_type = (isset($order_type) && $order_type != '') ? $order_type : 'whole_sale';
	...
	$order_type = (isset($_GET['order_type']) && $_GET['order_type'] !='') ? $_GET['order_type'] : 'whole_sale';
								...
								<div class="box-body">
									<div id="form" class="panel panel-warning" style="display: block;">
										<div class="panel-body">
											<form action="whole_sale.php" accept-charset="utf-8">
												...
												<div class="row">
													...
													<div class="col-sm-12">
														...
														<a href="whole_sale.php?order_type=<?php echo $order_type; ?>" class="btn btn-default">Reset</a>
													</div>
												</div>
											</form>
										</div>
									...
									<div class="row">
										...
										<div class="col-md-6 text-right pr0">
											<div class="dt-buttons btn-group">												
												...
												<a target="_blank" href="excel_export.php?sale=Counter Sale&order_type=whole_sale&get_type=excel&receipt_id=<?php echo $receipt_ids; ?>&shop=<?php echo $shops; ?>&payment_type=<?php echo $payment_types; ?>&from_date=<?php echo $from_date1; ?>&to_date=<?php echo $to_date1; ?>" class="btn btn-default buttons-csv buttons-html5 export"><span>Excel</span></a>
												 <?php } else { ?>
												<a target="_blank" href="excel_export.php?sale=Counter Sale&order_type=whole_sale&get_type=excel" class="btn btn-default buttons-csv buttons-html5 export"><span>Excel</span></a>
												<?php } ?>
